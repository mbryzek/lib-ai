...
package com.bryzek.claude.v0.models {
  ...
  object ClaudeModel {
    ...
    case object ClaudeOpus45 extends ClaudeModel { override def toString = "claude-opus-4-5" }
     ...
     * above.
     */
    val all: scala.List[ClaudeModel] = scala.List(ClaudeSonnet45, ClaudeHaiku45, ClaudeOpus45, ClaudeOpus46)
