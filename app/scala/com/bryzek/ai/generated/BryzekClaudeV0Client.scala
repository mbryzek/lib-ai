...
package com.bryzek.claude.v0.models {
  ...
  final case class ClaudeApiOutputFormat(
  ...
  final case class ClaudeRequest(
    ...
    outputFormat: _root_.scala.Option[com.bryzek.claude.v0.models.ClaudeApiOutputFormat] = None
  )
  ...
  object ClaudeModel {
    ...
    case object ClaudeSonnet46 extends ClaudeModel { override def toString = "claude-sonnet-4-6" }
    case object ClaudeHaiku45 extends ClaudeModel { override def toString = "claude-haiku-4-5" }
    case object ClaudeOpus46 extends ClaudeModel { override def toString = "claude-opus-4-6" }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
     * generated. We want to make it easy and obvious for users of
...
package com.bryzek.claude.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsClaudeClaudeApiOutputFormat: play.api.libs.json.Reads[com.bryzek.claude.v0.models.ClaudeApiOutputFormat] = {
      for {
      ...
      } yield ClaudeApiOutputFormat(`type`, schema)
    }

    def jsObjectClaudeApiOutputFormat(obj: com.bryzek.claude.v0.models.ClaudeApiOutputFormat): play.api.libs.json.JsObject = {
    ...
    implicit def jsonWritesClaudeClaudeApiOutputFormat: play.api.libs.json.Writes[ClaudeApiOutputFormat] = {
      (obj: com.bryzek.claude.v0.models.ClaudeApiOutputFormat) => {
        com.bryzek.claude.v0.models.json.jsObjectClaudeApiOutputFormat(obj)
      }
    }
    ...
    implicit def jsonReadsClaudeClaudeRequest: play.api.libs.json.Reads[com.bryzek.claude.v0.models.ClaudeRequest] = {
      for {
        ...
        outputFormat <- (__ \ "output_format").readNullable[com.bryzek.claude.v0.models.ClaudeApiOutputFormat]
    ...
    def jsObjectClaudeRequest(obj: com.bryzek.claude.v0.models.ClaudeRequest): play.api.libs.json.JsObject = {
      ...
      (obj.outputFormat match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("output_format" -> com.bryzek.claude.v0.models.json.jsObjectClaudeApiOutputFormat(x))
      })
    }
  ...
  object Bindables {
    ...
    object Models {
      ...
      val claudeModelConverter: ApibuilderTypeConverter[com.bryzek.claude.v0.models.ClaudeModel] = new ApibuilderTypeConverter[com.bryzek.claude.v0.models.ClaudeModel] {
        ...
        override def example: com.bryzek.claude.v0.models.ClaudeModel = com.bryzek.claude.v0.models.ClaudeModel.ClaudeSonnet46
