...
package com.bryzek.claude.response.v0.models {
  ...
  final case class InsightSection(
    title: String,
    icon: String,
    items: Seq[String] = Nil,
    subsections: Seq[com.bryzek.claude.response.v0.models.InsightSubsection] = Nil
  )

  final case class InsightSectionsResponse(
    steps: Seq[com.bryzek.claude.response.v0.models.ClaudeStep],
    sections: Seq[com.bryzek.claude.response.v0.models.InsightSection]
  )

  final case class InsightSubsection(
    heading: String,
    items: Seq[String]
  )
...
package com.bryzek.claude.response.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsClaudeResponseInsightSection: play.api.libs.json.Reads[com.bryzek.claude.response.v0.models.InsightSection] = {
      for {
        title <- (__ \ "title").read[String]
        icon <- (__ \ "icon").read[String]
        items <- (__ \ "items").readWithDefault[Seq[String]](Nil)
        subsections <- (__ \ "subsections").readWithDefault[Seq[com.bryzek.claude.response.v0.models.InsightSubsection]](Nil)
      } yield InsightSection(title, icon, items, subsections)
    }

    def jsObjectInsightSection(obj: com.bryzek.claude.response.v0.models.InsightSection): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "subsections" -> play.api.libs.json.Json.toJson(obj.subsections)
      )
    }

    implicit def jsonWritesClaudeResponseInsightSection: play.api.libs.json.Writes[InsightSection] = {
      (obj: com.bryzek.claude.response.v0.models.InsightSection) => {
        com.bryzek.claude.response.v0.models.json.jsObjectInsightSection(obj)
      }
    }

    implicit def jsonReadsClaudeResponseInsightSectionsResponse: play.api.libs.json.Reads[com.bryzek.claude.response.v0.models.InsightSectionsResponse] = {
      for {
        steps <- (__ \ "steps").read[Seq[com.bryzek.claude.response.v0.models.ClaudeStep]]
        sections <- (__ \ "sections").read[Seq[com.bryzek.claude.response.v0.models.InsightSection]]
      } yield InsightSectionsResponse(steps, sections)
    }

    def jsObjectInsightSectionsResponse(obj: com.bryzek.claude.response.v0.models.InsightSectionsResponse): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "steps" -> play.api.libs.json.Json.toJson(obj.steps),
    ...
    implicit def jsonWritesClaudeResponseInsightSectionsResponse: play.api.libs.json.Writes[InsightSectionsResponse] = {
      (obj: com.bryzek.claude.response.v0.models.InsightSectionsResponse) => {
        com.bryzek.claude.response.v0.models.json.jsObjectInsightSectionsResponse(obj)
      }
    }

    implicit def jsonReadsClaudeResponseInsightSubsection: play.api.libs.json.Reads[com.bryzek.claude.response.v0.models.InsightSubsection] = {
      for {
        heading <- (__ \ "heading").read[String]
        items <- (__ \ "items").read[Seq[String]]
      } yield InsightSubsection(heading, items)
    }

    def jsObjectInsightSubsection(obj: com.bryzek.claude.response.v0.models.InsightSubsection): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesClaudeResponseInsightSubsection: play.api.libs.json.Writes[InsightSubsection] = {
      (obj: com.bryzek.claude.response.v0.models.InsightSubsection) => {
        com.bryzek.claude.response.v0.models.json.jsObjectInsightSubsection(obj)
      }
    }
