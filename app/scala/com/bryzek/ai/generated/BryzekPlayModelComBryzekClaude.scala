/**
  ...
  * Service version: 2026-07-01T01:53:27.057Z
...
object ClaudeResponseContent {
  def apply(`type`: ClaudeContentType): com.bryzek.claude.models.ClaudeResponseContent = {
...
package object json {
  ...
  implicit def jsonReadsComBryzekClaudeModelsClaudeRequest: play.api.libs.json.Reads[com.bryzek.claude.models.ClaudeRequest] = {
    ...
    } yield com.bryzek.claude.models.ClaudeRequest(model, messages, maxTokens, system, outputFormat, thinking)
  }
