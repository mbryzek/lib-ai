/**
  ...
  * Service version: 2026-07-01T22:46:03.874Z
...
object ClaudeContentType {
  ...
  val all: scala.List[ClaudeContentType] = scala.List(Text, ToolUse, ToolResult, Thinking)
...
package object json {
  ...
  implicit def jsonReadsComBryzekClaudeModelsClaudeContentBlock: play.api.libs.json.Reads[com.bryzek.claude.models.ClaudeContentBlock] = {
    ...
    } yield com.bryzek.claude.models.ClaudeContentBlock(`type`, text, id, name, input, toolUseId, content, isError, thinking, signature, cacheControl)
  }
...
object KnownClaudeContentType {
  ...
  val all: scala.List[KnownClaudeContentType] = scala.List(Text, ToolUse, ToolResult, Thinking)
