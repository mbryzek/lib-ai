...
object ValidatedClaudeModel {
  ...
  case object ClaudeOpus47 extends ValidatedClaudeModel {
  ...
  val all: scala.List[ValidatedClaudeModel] = scala.List(ClaudeSonnet46, ClaudeHaiku45, ClaudeOpus47)
  ...
  def validate(value: _root_.com.bryzek.claude.models.ClaudeModel): _root_.cats.data.ValidatedNec[String, ValidatedClaudeModel] = {
    ...
    case _root_.com.bryzek.claude.models.ClaudeModel.ClaudeOpus47 => _root_.cats.data.Validated.validNec(ValidatedClaudeModel.ClaudeOpus47)
