...
object ClaudeModel {
  ...
  case object ClaudeOpus47 extends ClaudeModel { override def toString: String = "claude-opus-4-7" }
  final case class UNDEFINED(description: String) extends ClaudeModel { override def toString: String = description }

  val all: scala.List[ClaudeModel] = scala.List(ClaudeSonnet46, ClaudeHaiku45, ClaudeOpus47)
...
object KnownClaudeModel {
  ...
  case object ClaudeOpus47 extends KnownClaudeModel {
    override def toString: String = _root_.com.bryzek.claude.models.ClaudeModel.ClaudeOpus47.toString
    override def toClaudeModel: _root_.com.bryzek.claude.models.ClaudeModel = _root_.com.bryzek.claude.models.ClaudeModel.ClaudeOpus47
  }

  val all: scala.List[KnownClaudeModel] = scala.List(ClaudeSonnet46, ClaudeHaiku45, ClaudeOpus47)
  ...
  def validate(value: _root_.com.bryzek.claude.models.ClaudeModel): _root_.cats.data.ValidatedNec[String, KnownClaudeModel] = {
    ...
    case _root_.com.bryzek.claude.models.ClaudeModel.ClaudeOpus47 => _root_.cats.data.Validated.validNec(KnownClaudeModel.ClaudeOpus47)
